extract_drivers <- function(data){
  ...
  # Convert extracted free-text fields into binary indicator columns for
  # candidate drivers, responses, and measured variables.
  # Matching is case-insensitive to handle mixed capitalization in source text.
